...
- Finalize AI adapter/provider switching, advice & plan endpoints, and frontend integrations.
- Polish UX (tabs, toasts, keyboard flow) and ship full PWA (manifest + service worker).
- Harden offline queue with retries and sync indicators.
